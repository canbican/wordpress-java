...
public class Wordpress {
     ...
     * @throws InsufficientRightsException if the user does not have the moderate_comments cap or if the
     ...
     * @throws InsufficientRightsException if the user does not have the assign_terms cap for this taxonomy
     * @throws XmlRpcFault                 if there is a generic error during request
     * @throws XmlRpcFault                 if there is a generic error during request
     */
     ...
     *                                     specified in terms
     * @throws ObjectNotFoundException     if no author with that post_author ID exists or if no attachment
     ...
     * @throws InsufficientRightsException if the user does not have the edit_posts cap for this post type
    ...
    /**
     * @param filter filter for results, @see <a href=
     ...
     * @throws InsufficientRightsException if anonymous comments are disallowed and invalid credentials are
     ...
     * @throws XmlRpcFault                 if there is a generic error during request
     * @throws IOException                 if there is an I/O problem processing the file data on a
     *                                     temporary file
     */
